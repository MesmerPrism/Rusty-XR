...
use rusty_xr_camera_model::{
    ...
    full_view_content_uv_scale, project_camera_point, scale_intrinsics_to_image,
    stereo_homography_projection_metrics, CameraBasis, CameraCompositeTier, CameraPixelDomain,
    ImageSize, Pose, Quat, StereoHomographyProjection, StereoHomographyProjectionMetrics, Vec3,
};
