...
pub const ACAMERA_CONTROL_AE_TARGET_FPS_RANGE: u32 = 65_541;
...
pub const ACAMERA_LENS_POSE_REFERENCE_PRIMARY_CAMERA: u8 = 0;
pub const ACAMERA_LENS_POSE_REFERENCE_GYROSCOPE: u8 = 1;
pub const ACAMERA_LENS_POSE_REFERENCE_UNDEFINED: u8 = 2;
pub const ACAMERA_REQUEST_AVAILABLE_CAPABILITIES_LOGICAL_MULTI_CAMERA: u8 = 11;
pub const ACAMERA_LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE_APPROXIMATE: u8 = 0;
pub const ACAMERA_LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE_CALIBRATED: u8 = 1;
