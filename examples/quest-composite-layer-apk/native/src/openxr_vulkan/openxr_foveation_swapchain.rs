...
pub(super) unsafe fn enable_requested_openxr_fixed_foveation(
    ...
    enable_openxr_fixed_foveation(xr_instance, session, swapchain, level)
}

pub(super) unsafe fn enumerate_openxr_foveation_swapchain_images(
    xr_instance: &xr::Instance,
    swapchain: &xr::Swapchain<xr::Vulkan>,
