...
public final class CompositeLayerActivity extends NativeActivity {
    ...
    private void sendRuntimeConfig(boolean cameraEnabled, boolean mediaProjectionEnabled) {
        ...
        builder.append(",\"cameraProjectionDepthMeters\":").append(floatJson(floatExtra("rustyxr.cameraProjectionDepthMeters", DEFAULT_CAMERA_PROJECTION_DEPTH_METERS)));
        ...
        builder.append(",\"cameraProjectionAreaOpacity\":").append(floatJson(floatExtra("rustyxr.cameraProjectionAreaOpacity", DEFAULT_CAMERA_PROJECTION_AREA_OPACITY)));
        builder.append(",\"cameraProjectionBorderOpacity\":").append(floatJson(floatExtra("rustyxr.cameraProjectionBorderOpacity", DEFAULT_CAMERA_PROJECTION_BORDER_OPACITY)));
        builder.append(',');
        appendJsonString(builder, "cameraProjectionAlphaMode", stringExtra("rustyxr.cameraProjectionAlphaMode", DEFAULT_CAMERA_PROJECTION_ALPHA_MODE));
        builder.append(",\"cameraProjectionAlphaScale\":").append(floatJson(floatExtra("rustyxr.cameraProjectionAlphaScale", DEFAULT_CAMERA_PROJECTION_ALPHA_SCALE)));
        builder.append(",\"cameraProjectionAlphaBias\":").append(floatJson(floatExtra("rustyxr.cameraProjectionAlphaBias", DEFAULT_CAMERA_PROJECTION_ALPHA_BIAS)));
