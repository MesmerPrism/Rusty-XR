...
impl OesProjectionMetadata {
    pub(super) fn parse(value: &serde_json::Value) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            target_footprint_schema: content_geometry.target_footprint_schema,
            target_coordinate_space: content_geometry.target_coordinate_space,
            target_screen_uv_rect: content_geometry.target_screen_uv_rect,
            target_clip_policy: content_geometry.target_clip_policy,
            target_footprint_metadata_source: content_geometry.target_footprint_metadata_source,
            target_footprint_default: content_geometry.target_footprint_default,
